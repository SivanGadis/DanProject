...
@CucumberOptions(features = { "Feature" }, glue = { "stepDefinition" }, tags = { "@Test11111" }, plugin = { "pretty",
...
public class Runner {
	...
	public static void init() {
		...
		if (BrowserName == "Android_App") {
			...
			capabilities.setCapability("chromedriverExecutable", "C:\\ChromeDriver\\Android\\And_83\\chromedriver.exe");
